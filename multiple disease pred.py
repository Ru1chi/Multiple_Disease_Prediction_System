...
diabetes_model=pickle.load(open('diabetes_mode.sav','rb'))

hear_disease_model=pickle.load(open('heart_disease_model.sav','rb'))
parkisons_disease_model=pickle.load(open('parkinsons_model.sav','rb'))
